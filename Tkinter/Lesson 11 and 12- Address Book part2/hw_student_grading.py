...
mainWin=Tk()
mainWin.title('STUDENT INFORMATION AND MARKS LOGGER')
#-----------------------------------------------------------------------
#functions
myAddressBook={}
...
bookName = Label(mainWin, text='Student Report Log',width=35)
bookName.grid(row = 0, column = 0,pady = 10,columnspan=3)
...
#The display function will be executed every time an item in the Listbox is selected or the selection changes.
